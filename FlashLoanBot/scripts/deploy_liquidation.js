...
async function main() {
  ...
  console.log(`Deploying LiquidationBot with the account: ${deployer.address}`);
  ...
  const LiquidationBot = await hre.ethers.getContractFactory("LiquidationBot");
  ...
  console.log(`Add LIQUIDATION_CONTRACT=${address} to your .env`);
}
